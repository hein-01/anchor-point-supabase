          ...
          <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-xl p-2 flex items-center">
            ...
            <div className="flex-1 relative">
              <Input
                ...
                className="w-full border border-[#F5F4F8] border-l-0 rounded-l-none text-gray-600 placeholder-gray-400 focus-visible:ring-0 focus:border focus:border-primary text-sm sm:text-base placeholder:text-xs sm:placeholder:text-sm pr-12"
              />
              <button 
